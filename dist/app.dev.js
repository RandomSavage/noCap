...
var noCap = function noCap(score) {
  ...
  this.gameStart = function () {
    console.log("gameStart: ".concat(noCap.clues));
    ...
    fetch("https://jservice.io/api/clues?category=".concat(myCat[ranCat].id)).then(function (response) {
      ...
      inputBtn.addEventListener('click', function (e) {
        ...
        if (answer.trim().toLowerCase() === data[ranNum].answer.trim().toLowerCase()) {
          ...
          _scoreBox.innerText = this.score;
...
var atachThis = function atachThis() {
  console.log("whaaaa: ".concat(this.clues));
};

var displayValue = atachThis.bind(newGame);
displayValue(); // newGame.gameStart.bind(noCap)